...
bgColor.addEventListener("input", () => {
    ...
    document.querySelector("#code").style.backgroundColor = bgColor.value;
    // document.documentElement.setAttribute("style", `--primary-color: ${bgColor.value}`);
})
const primaryColor = document.querySelector("#primarycolor");
primaryColor.addEventListener("input", () => {

    document.documentElement.setAttribute("style", `--primary-color: ${primaryColor.value}`);
})
const cardColor = document.querySelector("#cardcolor");
cardColor.addEventListener("input", () => {

    document.documentElement.setAttribute("style", `--option-one: ${cardColor.value}`);
})